	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="DeleteUser">
...
<!--                                    <div class="wrap-input100 validate-input" data-validate="Enter sudo password">
						<input class="input100" type="password" name="sudoPassword" placeholder="sudoPassword">
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>-->
...
<!--===============================================================================================-->
	...
	<script type="text/javascript">
        ...
        if (status === "failed") {
            swal("Username doesn't exist,try with valid username");
        }
        if (status === "success") {
            swal("user deleted");
        }
